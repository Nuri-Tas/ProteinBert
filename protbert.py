...
class GOTermsDataModule(pl.LightningDataModule):
	def __init__(self, train_df, val_df, test_df, tokenizer, batch_size, max_token_len=MAX_LEN):
		super().__init__()
...
class GOTermTagger(pl.LightningModule):
	...
	def configure_optimizers(self):
		optimizer = torch.optim.AdamW(self.parameters(), lr=learning_rate, eps=1e-8)
...
#        pred_labels = m(outputs[1].flatten())
